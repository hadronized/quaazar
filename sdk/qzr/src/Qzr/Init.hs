...
mainHS = unlines
  ...
  , ""
  , "main :: IO ()"
  , "main = withQuaazar screenW screenH fullscreen screenTitle bootstrap"
  , ""
  , "bootstrap :: Window -> IO [Event] -> IO ()"
  , "bootstrap win pollEvents = void . runJournalT . runIOScopedT . runEitherT $ do"
  , "  info UserLog \"bootstrapping, please wait...\""
  , "  sink $ traverse_ print"
  , "  -- init and load from here on"
  , "  liftBase $ application win pollEvents"
  , ""
